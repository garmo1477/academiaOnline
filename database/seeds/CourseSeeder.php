...
class CourseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach($courses as $course){
            ...
            //buscamos de forma aleatoria un profesor y cogemos el id
            $course['user_id'] = User::whereRole(User::TEACHER)->get()->random()->id;
            //con unset eliminamos el dato de categorias y bg de un curso, ya que no pertenecem al modelo Curso
