...
class Unit extends Model
{
    ...
    protected static function boot(){
        //permite acceso a los eventos de los modelos de eloquent, en otras palabras, mientras esté pasando cosas haremos cosas 
        parent::boot();
    ...
    {
        //una unidad está relacionada con un curso
