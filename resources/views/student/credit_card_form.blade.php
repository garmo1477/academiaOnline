        ...
        <div class="row">
            <div class="col-lg-7 mx-auto">
                <div class="bg-white rounded-lg shadow-sm p-5">
                    {{-- Pestaña para tarjeta de crédito --}}                    
                            ...
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <label>
                                                <span class="hidden-xs">{{ __('Fecha de expiración') }}</span>
                                            </label>
                                ...
                                <button type="submit" class="site-btn btn-block rounded-pill shadow-sm">
                                    {{ __('Guardar tarjeta') }}
                                </button>
                            </form>
                        </div>
