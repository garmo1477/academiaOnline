...
@section('content')
    <section class="course-sectiojn spad">
        <div class="container">
        ...
        <div class="container">
                        ...
                        <tbody>
                            @foreach ($order->orderLines as $line)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="{{ route('courses.show', ['course' => $line->course]) }}">{{ __('Ir al curso') }}</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="row justify-content-center">
                <a href="{{ route('student.orders.download_invoice', ['order' => $order]) }}" class="site-btn">{{ __('Descargar factura') }}</a>
            </div>
        </div>
    </section>
@endsection