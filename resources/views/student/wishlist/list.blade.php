                    ...
                    <tbody>
                        @forelse($wishlist as $item)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a
                                        href="{{ route("add_course_to_cart", ["course" => $item->course]) }}"
                                        class="site-btn"
                                    >
                                        {{ __("Comprar el curso por :price", ["price" => $item->course->formatted_price]) }}
                                    </a>
                                </td>
                                <td class="align-middle">
                                    <a
                                        href="{{ route("student.wishlist.destroy", ["id" => $item->id]) }}"
