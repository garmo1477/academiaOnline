...
<section class="courses-section spad">   
        ...
        <div class="container">
            {{-- por si la validación del form falla, añadimos este include --}}
            ...
            <div class="form-group">
                ...
                {!! Form::select('courses[]', \App\Models\Course::forTeacher()->pluck('title','id'), null, ['class' => 'form-control', 'multiple' => true]) !!}
            </div>
